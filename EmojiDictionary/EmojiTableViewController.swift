...
class EmojiTableViewController: UITableViewController {
    ...
    let cellLayoutMarginsFollowReadableWidth = true
    ...
    var emojis: [Emoji] = [
        ...
        Emoji(symbol: "🏁", name: "Checkered Flag", description: "A black-and-white checkered flag.", usage:
            "completion"),
        Emoji(symbol: "🌮", name: "Taco", description:
            "A nice looking taco.", usage: "taco"),
        Emoji(symbol: "🤖", name: "Robot", description:
            "A happy robot.", usage: "Robot")]
